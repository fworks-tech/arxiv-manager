...
def log_generation_attempt(
    *,
    ...
    fact_check_errors: str = "",
    determinism_errors: str = "",
    ...
    try:
        record = GenerationAttempt(
            ...
            validation_errors=str(validation_errors or "")[:2000],
            validation_warnings=str(validation_warnings or "")[:2000],
            fact_check_errors=str(fact_check_errors or "")[:2000],
            determinism_errors=str(determinism_errors or "")[:2000],
